...
| :------------- | :------------- | :------------- | :------------- | :------------- |
| version | String | Yes | n/a | Must be "1.0" |
...
| viewFullTable | Boolean | No | true | Specifies the view mode for the layer as follows: <br>**true**: display the full table with tactic and technique names <br>**false**: display compact table with abbreviated tactic and technique names |
